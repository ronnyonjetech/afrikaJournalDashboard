...
const index = () => {
  ...
  return (
    // <Layout>
    //   <Layout.Body>
    //     <h1 className='mb-4 text-xl font-semibold'>Volumes List</h1>

    //     {loading && <p>Loading volumes...</p>}
    ...
    //                 <Link to={`/volumes/edit/${volume.id}`}>
    //                   <button
    //                     type='button'
    ...
    //                   Volume {volume.volume_number} • Issue{' '}
    //                   {volume.issue_number}
    //                 </CardDescription>
    //               </CardHeader>
