      ...
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md">
          ...
          <p className="text-2xl md:text-3xl font-light leading-normal">
            Sorry we couldn't find the article on this page.
          </p>
          <p className="mb-8">
            But don't worry, you can find plenty of other articles here.
          </p>
{/* 
        ...
        <div className="max-w-lg">
          ...
          >
            <defs>
              <style>{`
                .cls-1{fill:#d6b49a;}
                .cls-1,.cls-10,.cls-11,.cls-13,.cls-14,.cls-15,.cls-17,.cls-2,.cls-4,.cls-5,.cls-6{stroke:#000;}
                .cls-1,.cls-11,.cls-13,.cls-14,.cls-16,.cls-8{stroke-linecap:round;stroke-linejoin:round;}
                .cls-1,.cls-10,.cls-11,.cls-12,.cls-13,.cls-14,.cls-15,.cls-16,.cls-17,.cls-2,.cls-3,.cls-4,.cls-5,.cls-6,.cls-7,.cls-8,.cls-9{stroke-width:3px;}
                .cls-2{fill:#020202;}
            ...
            />
            <path className="cls-13" d="M1454.74,1016.08s2.76,17.42-17.24,15.42" />
            <path className="cls-13" d="M1455.63,1017.08s-2.76,17.42,17.24,15.42" />
