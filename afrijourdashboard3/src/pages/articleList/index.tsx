...
const index = () => {
  ...
  return (
    // <Layout>
    //   <Layout.Body>
    //     <h1 className='mb-4 text-2xl font-semibold'>Article List</h1>
    ...
    //           <div key={article.id} className='relative rounded-lg border p-4 shadow hover:shadow-md'>
    ...
    //                 // onClick={() => handleEdit(article.id)} // Implement edit routing if needed
    //               >
    ...
    //             <p className='text-sm text-gray-600'>Journal: {article.journal_title}</p>
    ...
    //             <p className='text-sm text-gray-600'>Date: {article.publication_date}</p>
