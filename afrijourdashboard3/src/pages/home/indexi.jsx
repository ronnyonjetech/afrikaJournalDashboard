...
//   // ✅ Track the last stored search URL
//   const [lastSearchUrl, setLastSearchUrl] = useState<string | null>(localStorage.getItem('lastSearchUrl'));
...
//   // ✅ Extract query from URL but DO NOT immediately update localStorage
//   useEffect(() => {
...
//       setSearchQuery(queryValue) // ✅ Only update search state
//       setStorageUpdate(prev => prev + 1) // ✅ Force search re-run
...
//   // ✅ Fetch journals & update localStorage after successful fetch
...
//       // ✅ ONLY UPDATE localStorage after successful fetch
...
//   // ✅ Fetch when query, page, or storageUpdate changes
//   // useEffect(() => {
//   //   fetchJournals()
//   // }, [searchQuery, storageUpdate, currentPage])
 

//     const fetchJournals1 = async () => {
//     setLoading(true)
//     try {
//       const url = 'https://aphrc.site/journal_api/journals/search/?page=1&page_size=10'
//       console.log('Fetching from:', url)
//       const response = await fetch(url)
//       const data = await response.json()
//       setJournals(data.results)
...
//   // ✅ Refresh button resets but keeps the last successful search URL
//   const handleRefresh = () => {
